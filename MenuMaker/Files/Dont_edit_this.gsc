...
CreateMenu()
{
    ...
    self add_option("Main Menu", "Option 1");
    self add_option("Main Menu", "Option 2");
    self add_option("Main Menu", "Option 3");
    self add_option("Main Menu", "Option 4");
    self add_option("Main Menu", "Option 5");
    self add_option("Main Menu", "Option 6");
    self add_option("Main Menu", "Menu 1", ::submenu, "Menu1", "Menu 1");
    self add_option("Main Menu", "Menu 2", ::submenu, "Menu2", "Menu 2");
    self add_option("Main Menu", "Players Menu", ::submenu, "Players", "Players Menu");

    self add_menu("Menu1", "Main Menu", "User");
    self add_option("Menu1", "Option 1");

    self add_menu("Menu2", "Main Menu", "User");
    self add_option("Menu2", "Option 1");

    self add_menu("Players", "Main Menu", "User");
    self add_option("Players", "Player 1");
}
